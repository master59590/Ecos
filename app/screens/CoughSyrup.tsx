  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.box}>
        <Image
          source={{
            uri: 'https://st.bigc-cs.com/cdn-cgi/image/format=webp,quality=90/public/media/catalog/product/40/88/8850360310040/8850360310040_4.jpg',
          }}
        ...
        <Text style={styles.medicineDetails}>
          รับประทาน 1-2 ช้อนโต๊ะ 3-4 ครั้งต่อวันจนกว่าอาการจะดีขึ้น
        </Text>
      </View>
